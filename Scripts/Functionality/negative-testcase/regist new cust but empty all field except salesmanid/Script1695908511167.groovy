...
WebUI.click(findTestObject('Object Repository/Page_Prieds Technology/span_ACCURATE'))

WebUI.click(findTestObject('Object Repository/Page_Prieds Technology/button_Submit'))
